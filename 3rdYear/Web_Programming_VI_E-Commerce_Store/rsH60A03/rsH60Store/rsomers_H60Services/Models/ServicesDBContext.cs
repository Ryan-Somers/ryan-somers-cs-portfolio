...
public partial class ServicesDBContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            // Configure SQL Server only if no other provider is configured
            optionsBuilder.UseSqlServer("Server=cssql.cegep-heritage.qc.ca;Database=test_H60Assignment3DB_rs;User id=RSOMERS;Password=password;TrustServerCertificate=true;");
        }
    }
