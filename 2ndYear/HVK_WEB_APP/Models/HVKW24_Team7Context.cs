...
{
    public partial class HVKW24_Team7Context : DbContext
    {
        public HVKW24_Team7Context()
        {
        }

        public HVKW24_Team7Context(DbContextOptions<HVKW24_Team7Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=cssql.cegep-heritage.qc.ca; Database= HVKW24_Team7; User id= W24HVKTEAM7;  Password=password; ");
            }
        }
